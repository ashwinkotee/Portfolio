const SkillsSection = () => {
	const skills = [
		{
			category: 'Languages',
			items: ['JavaScript', 'TypeScript', 'Java', 'Python', 'HTML5', 'CSS', 'JSON'],
			icon: (
		...
		{
			category: 'Frontend',
			items: ['React', 'Angular', 'Redux', 'RxJS', 'Next.js', 'Tailwind CSS'],
			icon: (
				<svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="#9DA2AF" strokeWidth="2">
		...
		{
			category: 'Backend',
			items: ['Node.js', 'Express.js', 'Spring Boot', 'REST APIs', 'GraphQL'],
			icon: (
				<svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="#9DA2AF" strokeWidth="2">
					<path d="M5 12h14M5 12a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v4a2 2 0 01-2 2M5 12a2 2 0 00-2 2v4a2 2 0 002 2h14a2 2 0 002-2v-4a2 2 0 00-2-2" />
				</svg>
		...
		},
		{
			...
			items: ['MongoDB', 'PostgreSQL', 'SQL', 'Redis', 'Azure', 'AWS', 'GCP'],
			icon: (
				<svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="#9DA2AF" strokeWidth="2">
